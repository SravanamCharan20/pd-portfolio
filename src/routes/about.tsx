  ...
  return (
    <>
      ...
      <div className="sticky top-0 h-screen w-screen overflow-hidden">
        ...
        <header className="absolute top-0 left-0 right-0 z-50 py-6 px-6 flex items-center justify-between md:hidden">
        ...
        <nav className="hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 z-[60] items-center gap-1 px-2 py-2 rounded-full bg-black/[0.06] backdrop-blur-xl shadow-[0_0_0_1px_rgba(0,0,0,0.04),0_8px_40px_-12px_rgba(0,0,0,0.1)] pill-nav">
          ...
          <a href="/about" className="px-4 py-1.5 rounded-full text-[13px] font-medium text-ink/90 bg-black/[0.06] transition-all duration-200">About</a>
